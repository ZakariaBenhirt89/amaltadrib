            ...
            @csrf
             <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input required type="text" id="start" name="start" class="form-control" value="{{ $internship->start }}" placeholder="من..." />
                </div>
                <div class="form-group col-md-3">
                    <label for="end">إلى:</label>
                    <input required type="text" id="end" name="end" class="form-control" value="{{ $internship->end }}" placeholder="إلى..." />
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input required type="text" id="address" name="address" class="form-control" value="{{ $internship->address }}" placeholder="العنوان..." />
                </div>
                <div class="form-group col-md-3">
